...
tidy_dataset = "cdi_ca_1977_wk_prov_statcan"
digitization = "cdi_ca_1977_wk_prov_statcan"
...
clean_sheets = function(
  ...
  (beheaded_sheet
    ...
    %>% mutate(cases_statistic = case_when(
      ...
      (startsWith(stat_name_1, 'Total'    ) & startsWith(stat_name_2, '1977')) ~ 'cum_report_year',
      (is.na(stat_name_1) & startsWith(stat_name_2, '1975')) ~ 'cum_prev_year',
      (is.na(stat_name_1) & startsWith(stat_name_2, '1976')) ~ 'cum_prev_year'
    ))
