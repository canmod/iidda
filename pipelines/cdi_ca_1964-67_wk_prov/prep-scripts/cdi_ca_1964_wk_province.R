...
tidy_dataset = "cdi_ca_1964_wk_prov_mcgill"
digitization = "cdi_ca_1964_wk_prov_mcgill"
...
clean_sheets = function(
  ...
  (beheaded_sheet
    ...
    %>% mutate(cases_statistic = case_when(
      ...
      startsWith(stat_name_2, '1964'      ) ~ 'cum_report_year',
      startsWith(stat_name_2, '1963'      ) ~ 'cum_prev_year',
