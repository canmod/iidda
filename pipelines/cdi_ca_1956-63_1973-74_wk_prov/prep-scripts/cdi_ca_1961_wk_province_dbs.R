...
tidy_dataset = "cdi_ca_1961_wk_prov_dbs"
digitization = "cdi_ca_1961_wk_prov_dbs"
...
clean_sheets = function(
  ...
  (beheaded_sheet
    ...
    %>% mutate(cases_statistic = case_when(
      ...
      startsWith(stat_name_2, '1961'      ) ~ 'cum_report_year',
      startsWith(stat_name_2, '1960'      ) ~ 'cum_prev_year',
