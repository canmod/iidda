...
tidy_dataset = "cdi_ca_1957_wk_prov_dbs"
digitization = "cdi_ca_1957_wk_prov_dbs"
...
clean_sheets = function(
  ...
  (beheaded_sheet
    ...
    %>% mutate(cases_statistic = case_when(
      ...
      startsWith(stat_name_2, '1957'        ) ~ 'cum_report_year',
      startsWith(stat_name_2, '1956'        ) ~ 'cum_prev_year',
