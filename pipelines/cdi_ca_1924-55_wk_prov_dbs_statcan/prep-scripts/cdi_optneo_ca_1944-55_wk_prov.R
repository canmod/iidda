...
tidy_dataset = "cdi_optneo_ca_1944-55_wk_prov"
digitization = "cdi_optneo_ca_1944-55_wk_prov"
  ...
  (data
   ...
   %>% mutate(
     cases_this_period = ifelse(
       time_scale == 'mo' & as.Date(period_end_date, format="%B %d %Y") <= as.Date("December 30 1944", format="%B %d %Y"),
       'Not available',
       cases_this_period
     ))
