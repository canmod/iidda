...
tidy_dataset = "cdi_granuing_ca_1946-55_wk_prov"
digitization = "cdi_granuing_ca_1946-55_wk_prov"
...
# This just removes all the data, since there are no reported cases for granuloma from 1924-55.
