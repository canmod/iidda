...
# This causes the year start and end date for 1942 to be different than that of the other files.

# ----------------------------------------
# Information for Locating Metadata
tidy_dataset = "cdi_smallpox_ca_1924-55_wk_prov"
digitization = "cdi_smallpox_ca_1924-55_wk_prov"
...
missing_values = function(data){
  (data
   ...
   # NS reporting in 1924, 1927 onwards
   %>% mutate(
     cases_this_period = ifelse(
       # 1924: empty = 0 
       (location == 'N.S.'
