...
tidy_dataset = "cdi_polionpar_ca_1949-55_wk_prov"
digitization = "cdi_polionpar_ca_1949-55_wk_prov"
...
behead_sheet = function(focal_sheet, data) {
  if(focal_sheet == 1954){
    beheaded =
      (data
       ...
       %>% mutate(fixed_statname = ifelse(is.na(location), 'wk', 'mo'))
  ...
  beheaded$collection_year = focal_sheet
