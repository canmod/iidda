...
tidy_dataset = "cdi_typhpara_ca_1952-55_wk_prov"
digitization = "cdi_typhpara_ca_1952-55_wk_prov"
...
missing_values = function(data){
  (data
   # all provinces are reporting, so convert empty cells and dashes to 0
...
# filtering out sheets that are already prepped in paratyphoid script
sheets = sheets[!(sheets %in% c('1955_para', '1954_para'))] 
