...
# Scans are missing the week ending 1954-01-02, causing these yearly periods
# to differ from other files yearly periods

# ----------------------------------------
# Information for Locating Metadata
tidy_dataset = "cdi_poliopar_ca_1949-55_wk_prov"
digitization = "cdi_poliopar_ca_1949-55_wk_prov"
...
clean_sheet=function(beheaded_sheet, focal_sheet_info){
  clean_weeks = (beheaded_sheet
                 ...
                 %>% filter(!(stat_name == 'mo' & month == 'Sep' & week_ending == '29' ))
  )
